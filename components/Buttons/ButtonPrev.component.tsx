...
interface ButtonPrevProps extends Omit<ButtonProps, 'title'>{
    style?: ViewStyle
    title?: string,
    asButton?: boolean
}

const ButtonPrev: React.FC<ButtonPrevProps> = ({disabled, asButton, style, title, ...props}) => (
    <TouchableOpacity style={[styles.touchable, asButton? styles.button : null, style, disabled? styles.disabled : null]} disabled={disabled} {...props}>
        <Ionicons name="md-caret-back" size={26} color={ colors.copper } style={styles.icon} />
