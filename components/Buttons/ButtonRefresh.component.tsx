...
interface ButtonRefreshProps extends Omit<ButtonProps, 'title'>{
    style?: ViewStyle
    title?: string,
    asButton?: boolean
}

const ButtonRefresh: React.FC<ButtonRefreshProps> = ({disabled, asButton, style, title, ...props}) => (
    <TouchableOpacity style={[styles.touchable, asButton? styles.button : null, style, disabled? styles.disabled : null]} disabled={disabled} {...props}>
        <Ionicons name="md-refresh" size={26} color={ colors.copper } style={styles.icon} />
